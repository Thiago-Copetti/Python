...
peso = float(input('Informe o peso de peixe : '))

if peso > 50:
    excesso_peso = peso - 50
    multa = excesso_peso * 4
    print(f'O excedeu em {excesso_peso:.2f} Kg e a multa será de R$ {multa:.2f}')
else:
    print('Você não excedeu o peso limite, portanto não irá pagar multa')
